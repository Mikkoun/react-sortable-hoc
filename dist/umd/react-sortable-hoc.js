...
/***/ (function(module, exports, __webpack_require__) {
	...
	function sortableContainer(WrappedComponent) {
	  ...
	  return _temp = _class = function (_PureComponent) {
	    ...
	    return _class;
	  }(_react.PureComponent), _class.displayName = (0, _utils.provideDisplayName)('sortableList', WrappedComponent), _class.defaultProps = {
	    axis: 'y',
	  ...
	  return _temp = _class = function (_PureComponent) {
	    ...
	    (0, _createClass3.default)(_class, [{
	      ...
	      value: function render() {
	        ...
	        return _react2.default.createElement(WrappedComponent, (0, _extends3.default)({ ref: ref }, (0, _utils.omit)(this.props, 'collection', 'disabled', 'index')));
	      }
	    }]);
	    return _class;
	  }(_react.PureComponent), _class.displayName = (0, _utils.provideDisplayName)('sortableElement', WrappedComponent), _class.contextTypes = {
	    manager: _propTypes2.default.object.isRequired
	  }, _class.propTypes = {
